...
项目已新增后端原型目录 [`backend/`](./backend)，用于跑通：

- `server1`：任务编排、密文聚合、迭代状态
- `server2`：密钥管理、解密、`c_t` 决策

详细启动与联调命令见 [`backend/README.md`](./backend/README.md)。
...
- [ ] 增加角色泳道图：个体、Server1、Server2 的消息交互过程7777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777
